...
@Service
public class GetRightPosterByNationServiceImpl implements GetRightPosterByNationService {
    ...
    @Override
    public String getRightPosterByNation(String category) {
        List<FirstPageTicketInfo> fptilist = new ArrayList<FirstPageTicketInfo>();
        List<TicketInfo> rightPosterInfoList = fprp.getRightPosterTicketInfoByNation(category);
